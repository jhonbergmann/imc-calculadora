...
import LottieViewBMI from './LottieViewBMI'

export default function ModalBMI(props) {
  return (
    <View style={styles.centeredView}>
      <Modal
        animationType='slide'
        transparent={true}
        visible={props.modalVisibleBmi}
        onRequestClose={() => {
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text style={styles.modalText}>Seu IMC é {props.bmi}</Text>
            <LottieViewBMI />
